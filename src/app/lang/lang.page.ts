...
export class LangPage implements OnInit {
  ...
  type:any;
  text:any;
  constructor(public server : ServerService,public toastController: ToastController,public loadingController: LoadingController,private nav: NavController,public events: EventsService)
  {
